...
**Updated `tests\ProgressionLab.FunctionalTests\ProgressionLab.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\ProgressionLab.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\ProgressionLab.FunctionalTests\ProgressionLab.FunctionalTests.csproj
```
