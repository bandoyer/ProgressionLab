...
1. Set `ProgressionLab.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../ProgressionLab.Infrastructure/ProgressionLab.Infrastructure.csproj -s ProgressionLab.Web.csproj -o Data/Migrations
```
